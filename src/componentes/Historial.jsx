  ...
  return (
    <div className="historial">
      ...
      <i class="fa-solid fa-clock-rotate-left"></i>
        ...
        <input type="text" placeholder="Buscar por lista o usuario" className="buscador" />

        <span class="EditarBtn"><i class="fa-solid fa-arrow-up-from-bracket"></i>Exportar</span>
